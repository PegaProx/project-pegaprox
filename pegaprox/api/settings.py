...
def _sanitize_acme_dns_settings(settings, data):
    ...
    secret = str(data.get('acme_dns_rfc2136_secret', settings.get('acme_dns_rfc2136_secret', '')) or '').strip()
    if secret != '********':
        settings['acme_dns_rfc2136_secret'] = secret
...
def _acme_dns_config(settings):
    return {
        ...
        'secret': settings.get('acme_dns_rfc2136_secret', ''),
